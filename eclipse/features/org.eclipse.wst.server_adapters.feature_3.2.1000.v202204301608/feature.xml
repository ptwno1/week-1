...
<feature
      ...
      label="%featureName"
      version="3.2.1000.v202204301608"
   ...
   <!-- 
      ...
      These two jetty plugins are already required by 
      org.eclipse.wst.server.preview/META-INF/MANIFEST.MF, 
      so no need to include or require them here
   <requires>
     <import plugin="org.eclipse.jetty.webapp"/>
   ...
   <plugin
         ...
         download-size="43"
         install-size="78"
         version="1.1.600.v202106111324"
         unpack="false"/>

   <plugin
         id="jakarta.enterprise.cdi-api"
         download-size="129"
         install-size="259"
         version="2.0.2"
         unpack="false"/>
